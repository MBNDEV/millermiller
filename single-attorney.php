            ...
            <div class="grid-x grid-margin-x">
                <div class="cell large-6">
                    ...
                    <ul class="email-vcard">
                        <li><a href=""><img src="<?php bloginfo('template_url') ?>/assets/img/icn-email.svg" alt=""> EMAIL</a></li>
        ...
        <div class="grid-container">
            <div class="grid-x grid-margin-x">
                <div class="cell large-4">
                    ...
                    <div class="bio-menu sticky" data-sticky data-anchor="bio"  data-margin-top="5">
                        <ul data-magellan>
                ...
                <div class="cell large-8">
                    ...
                    <blockquote>It is my job to make sure a public project is properly authorized, its design is modified to mitigate impact on my client’s property as much as possible, and insure that my client receives full and fair compensation for both the property being taken by the government and any diminution in value caused to any portion of the property not being taken. I am committed to doing my job in every case and for every client.</blockquote>
                    ...
                    <div class="bio-testimonials testi-s1">
