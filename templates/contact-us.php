                        ...
                        <div class="cell small-12 medium-6">
                            <ul class="footer-lists">
                                <li>
                                    ...
                                    <span>
                                        <a href="https://goo.gl/maps/Dbvxrd4KgecodzgPA" target="_blank" class="text-gray">200-B Monroe Street, <br>Rockville, MD 20850</a>
                                    </span>
                                </li>
                                <li>
                                    <span><img src="<?= get_template_directory_uri(); ?>/assets/img/icn-phone.svg" alt="location" title="location"></span>
                                    <span><a href="tel:3017625212" class="text-gray">301-762-5212</a></span>
                                </li>
                                <li>
