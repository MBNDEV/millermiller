...
<main id="content">
    ...
    <div class="grid-x grid-margin-x rep-case-lists">
        <div class="medium-6 large-6 cell grid-item">
            <div class="box grid-x grid-padding-x">
            ...
            <h2>Industrial & Residentially Zoned - Unimproved Property</h2>
        ...
        <div class="medium-6 large-6 cell grid-item">
            <div class="box grid-x grid-padding-x">
                <div class="cell small-6">
                    <div class="thumb">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/case-before-2.jpg" alt="">
                        <span>Before</span>
                    </div>
                </div>
                <div class="cell small-6">
                    <div class="thumb">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/case-after-2.jpg" alt="">
                        <span>Before</span>
                    </div>
                </div>
            </div>
